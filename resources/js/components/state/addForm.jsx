...
export default function AddForm({ form, onChange, onCountryChange, onSubmit, onCancel, isSubmitting, errors = {}, countries = [] }) {
    return (
        <Card>
            <CardHeader>
                <CardTitle>Create State</CardTitle>
                <CardDescription>Fill in the state details and save to create a new record.</CardDescription>
            </CardHeader>
