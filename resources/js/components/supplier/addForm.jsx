...
export default function AddForm({ form, onChange, onSelectChange, onSubmit, onCancel, isSubmitting, errors = {} }) {
    return (
        <Card>
            <CardHeader>
                <CardTitle>Create Supplier</CardTitle>
                <CardDescription>Fill in the supplier details and save to create a new record.</CardDescription>
            </CardHeader>
