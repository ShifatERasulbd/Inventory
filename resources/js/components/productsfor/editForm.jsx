...
export default function EditForm({ form, onChange, onSubmit, onCancel, isSubmitting, errors = {} }) {
    return (
        <Card>
            <CardHeader>
                <CardTitle>Edit Products For</CardTitle>
                <CardDescription>Update products-for details and save your changes.</CardDescription>
            </CardHeader>
            ...
            <form onSubmit={onSubmit}>
                ...
                <CardFooter className="justify-end gap-2 border-t pt-6">
                    ...
                    <Button type="submit" disabled={isSubmitting}>
                        {isSubmitting ? 'Updating...' : 'Update Products For'}
                    </Button>
                </CardFooter>
            </form>
        </Card>
